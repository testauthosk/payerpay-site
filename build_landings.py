...
def render_usd(d):
    b = FLAG_SPRITE
    b += hero(d, hero_image("../assets/hero-lp-usd.webp?v=2", "Personal USD payment details funded by incoming payments from around the world"))
...
INDIA = {
  ...
  "heroImg": "../assets/hero-lp-india.webp?v=2",
...
PHIL = {
  ...
  "heroImg": "../assets/hero-lp-philippines.webp?v=2",
